<template>
    <div class="ymf-line-config">
        <div class="field-title">折线图设置</div>
        <br>
        <div style="width: 90%;margin: 0 auto;">
            <el-form label-width="120px" label-suffix="：">
                <el-form-item label="显示类型">
                    <el-radio-group v-model="source.lineType">
                        <el-radio label="line">线段</el-radio>
                        <el-radio label="point">点状</el-radio>
                    </el-radio-group>
                </el-form-item>
                <el-form-item label="线段形状">
                    <el-radio-group v-model="source.shape">
                        <el-radio label="line">线段</el-radio>
                        <el-radio label="dash">虚线</el-radio>
                        <el-radio label="smooth">平滑线</el-radio>
                    </el-radio-group>
                </el-form-item>
                <h3>数据</h3>
